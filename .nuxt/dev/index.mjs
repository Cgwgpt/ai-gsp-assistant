...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://D:/cgwxmcg/nbb/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/cgwxmcg/nbb/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/cgwxmcg/nbb/node_modules/devalue/index.js';
import destr from 'file://D:/cgwxmcg/nbb/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://D:/cgwxmcg/nbb/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/cgwxmcg/nbb/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/cgwxmcg/nbb/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/cgwxmcg/nbb/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/cgwxmcg/nbb/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/cgwxmcg/nbb/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/cgwxmcg/nbb/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/cgwxmcg/nbb/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/cgwxmcg/nbb/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/cgwxmcg/nbb/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/cgwxmcg/nbb/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/cgwxmcg/nbb/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/cgwxmcg/nbb/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://D:/cgwxmcg/nbb/node_modules/vue/index.mjs';
import { hash } from 'file://D:/cgwxmcg/nbb/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/cgwxmcg/nbb/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/cgwxmcg/nbb/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/cgwxmcg/nbb/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/cgwxmcg/nbb/node_modules/@unhead/shared/dist/index.mjs';
...
const _8MP0EwYqVF = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/cgwxmcg/nbb";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Modern Web App"};
...
const _lazy_8EThWk = () => Promise.resolve().then(function () { return hello$1; });
const _lazy_MjhBaI = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/hello', handler: _lazy_8EThWk, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_MjhBaI, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_MjhBaI, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"D:/cgwxmcg/nbb/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\cgwxmcg\\nbb","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\cgwxmcg\\nbb\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\cgwxmcg\\nbb\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\cgwxmcg\\nbb\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\cgwxmcg\\nbb\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "supabase": {
      "url": "https://clgvxmriyzxooouykryd.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNsZ3Z4bXJpeXp4b29vdXlrcnlkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzIwNzk1ODgsImV4cCI6MjA0NzY1NTU4OH0.Trk_tt1t3JJ-N0zNxHxcPqNlsWbCfPjlgK6IC0GEJzQ",
      "redirect": false,
      "redirectOptions": {
        "login": "/login",
        "callback": "/confirm",
...
const getClientManifest = () => import('file://D:/cgwxmcg/nbb/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/cgwxmcg/nbb/.nuxt/dist/server/server.mjs').then((r) => r.default || r);

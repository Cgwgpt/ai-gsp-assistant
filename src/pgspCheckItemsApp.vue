<template>
    <div class="gsp-app">
      <!-- <header class="app-header">
        <div class="header-content">
          <h1 class="app-title">批发企业检查项目共256项，其中严重缺陷项目（**）10项，主要缺陷项（*）103项，一般缺陷项143项</h1>
        </div>
      </header> -->
  ...
  <script>
  import { pgspCheckItems } from './data/pgspCheckItems.js'
  
  export default {
    name: 'PgspCheckItemsApp',
    data() {
      return {
        searchQuery: '',
